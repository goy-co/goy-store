...
### Changed
- Bumped Rust crate version to `0.1.1-alpha` for crates.io publishing with GSAL license-file.
- Added dedicated `README.md` and `LICENSE` to Rust crate and Go module.
- Automated Go module indexing on proxy.golang.org and pkg.go.dev.
